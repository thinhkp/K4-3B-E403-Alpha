...
| 2 | Job executor (ai · đang ở đâu · làm gì) | Minh đang học trên VLearn, vừa bôi đen một đoạn hoặc đang mở một phần bài học và tự gõ câu hỏi để hiểu tiếp. |
| 3 | Pain một câu (ai – đang làm gì – vướng đâu – hậu quả) | Khi hỏi để làm rõ nội dung đang mở, Minh có thể nhận câu trả lời không có trang nguồn hoặc tutor vẫn trả lời khi ngữ cảnh chưa đủ; Minh không biết dựa vào đâu để kiểm tra nên phải tự dò lại và có nguy cơ học sai. |
